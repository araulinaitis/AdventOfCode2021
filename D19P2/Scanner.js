...
export default class Scanner {
  ...
  calcManhattanDistance(otherScanner) {
    return (
      Math.abs(otherScanner.offsetFrom0.x - this.offsetFrom0.x) +
      Math.abs(otherScanner.offsetFrom0.y - this.offsetFrom0.y) +
      Math.abs(otherScanner.offsetFrom0.z - this.offsetFrom0.z)
    );
  }
}
